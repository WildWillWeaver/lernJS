...
if(!empty($_POST['send'])) {
	...
	mail("comp.technika@ya.ru", $theme, $mess, "From: beget.ru <mymail@mail.ru>\nContent-Type: text/html;\n charset=utf-8\nX-Priority: 0");
	
	echo "<p>Заявка удачно оформлена.</p>";
	echo "<p>Заявке присвоен номер Z".$Nzakaz.".<br> Наш менеджер свяжется<br> с вами в ближайшее время.</p>";
